...
const AboutIntro: React.FC = () => {
  return (
    <section className="w-full py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 grid md:grid-cols-2 gap-10 md:gap-14 items-center">
        {/* Left Image Section with overlay */}
        <div className="relative w-full flex justify-start pl-0">
        ...
        <div className="space-y-6">
          {/* Yellow HR line above the title */}
